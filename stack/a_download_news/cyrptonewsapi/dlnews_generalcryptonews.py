...
def run(start_dt, end_dt):
    ...
    while True:
        ...
        url = f'https://cryptonews-api.com/api/v1/category?section=general&type=article&items=100&page={page}&token={keys.CRYPTONEWSAPI_KEY}'
        ...
        for data in response_data:
            ...
            id = f'article.cryptonewsapi.generalcryptonews.{data["source_name"].replace(" ", "")}.{date_str}.{time_str}.{sanitized_headline}.yaml'
