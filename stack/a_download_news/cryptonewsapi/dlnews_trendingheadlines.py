...
def run(start_dt, end_dt):
    ...
    logging.info(f'------------------------------------------------------------------------------------------')
    logging.info(f'[BEGIN] Download news for cyrptonewsapi_trendingheadlines')
    ...
    while True:
        ...
        url = f'https://cryptonews-api.com/api/v1/trending-headlines?&page={page}&token={keys.CRYPTONEWSAPI_KEY}'
        ...
        for data in response_data:
            ...
            id = f'article.cryptonewsapi.trendingheadlines.undefined.{date_str}.{time_str}.{sanitized_headline}.yaml'
    ...
    logging.info(f'[END  ] Download news for cyrptonewsapi_trendingheadlines')
